...
export default function ErrorState({ error, onRetry, onBack }: ErrorStateProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 animate-fade-in">
      <div className="w-16 h-16 bg-red-50 dark:bg-red-900/20 rounded-2xl flex items-center justify-center mb-5">
        <AlertCircle className="w-8 h-8 text-red-400" />
      </div>
      <h3 className="text-xl font-bold text-gray-900 dark:text-warm-100 mb-2">Recipe Generation Failed</h3>
      <p className="text-warm-400 text-sm text-center max-w-sm mb-3">{hint}</p>
      <div className="px-4 py-2.5 bg-red-50 dark:bg-red-900/10 border border-red-200 dark:border-red-900 rounded-xl max-w-sm w-full mb-6">
